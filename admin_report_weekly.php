		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Weekly Charts</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="bg-white pd-20 card-box mb-30">
					<h4 class="h4 text-blue">Weekly sales chart</h4>
				...
				<div class="bg-white pd-20 card-box mb-30">
					<h4 class="h4 text-blue">Herbs sold this week</h4>
                    ...
                    <tbody>
                      <?php 
 $daily_query = "SELECT * FROM ORDERS WHERE ORDER_TIME >= trunc(sysdate,'D') ORDER BY PRODUCT_ID ASC";
 ...
 <script type="text/javascript">
    ...
    function drawChart() {
      var data = google.visualization.arrayToDataTable([
        ...
        <?php
        $daily_query = "SELECT DELIVERY_DAY, SUM(QUANTITY) AS QUANTITY FROM ORDERS GROUP BY DELIVERY_DAY ORDER BY DELIVERY_DAY ASC";
         $stid = oci_parse($con, $daily_query);
          ...
          $quantity = $row['QUANTITY'];
          ?>
           ["<?php echo $row['DELIVERY_DAY'];?>", <?php echo $quantity;?>, "orange"],
           <?php 
        }
           ?>
           ]);
      ...
      var chart = new google.visualization.ColumnChart(document.getElementById("weeklysales"));
  ...
  <!--Daily Sales Summary Report-->
   ...
   <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Weekly Sales Per Product',
          legend: 'none',
          pieSliceText: 'label',
          pieHole: 0.4,
          backgroundColor: { fill:'transparent'},
