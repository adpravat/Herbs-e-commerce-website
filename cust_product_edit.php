				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-12 col-sm-12">
                         ...
                         <div class="row">
                        <br>
                        <form style="margin-left:270px" action="cust_product_edit_process.php" method="post" enctype="multipart/form-data">
                           ...
                           <div class="group-input">
                            ...
                            <div class="group-input">
                                ...
                                <input style="margin-left: 118px;" type="text" name="name" value ="<?php echo $product_name ?? '' ?>">
                            </div>
                          <div class="group-input">
                                <label>Herb Price *</label>
                                <input style="margin-left: 124px;" type="number" name="rate" value ="<?php echo $price ?? '' ?>">
                            </div>
                            <div class="group-input">
