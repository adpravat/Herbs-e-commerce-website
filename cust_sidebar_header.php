				...
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						<?php
                         ...
                         {
                     echo '<a class="dropdown-item" href="logout.php"><i class="dw dw-logout"></i> Log Out</a>';
                        }
                          ?>
				...
				<ul id="accordion-menu">
                     ...
                     <li class="dropdown">
						...
						<ul class="submenu">
							...
							<li><a href="./cust_product_view.php">My Herbs</a></li>
							<li><a href="./cust_product_add.php">Add Herbs</a></li>
                       ...
                       echo '<li><a href="./shoping-cart.php">Shoping Cart</a></li>';
                            ...
                            ?>
                            <li><a href="cust_report_daily.php">Daily sales report</a></li>
							<li><a href="cust_report_weekly.php">Weekly sales report</a></li>
							<li><a href="cust_report_monthly.php">Monthly sales report</a></li>             
						</ul>
					</li>
				</ul>
			</div>
